                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <form role="form">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    <label for="patent_title">Judul</label>
                                                    <textarea class="form-control" id="patent_title" rows="3" placeholder="Judul Paten ..."></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for="patent_status">Status Paten</label>
                                                    <select class="form-control">
                                                        <option>Granted</option>
                                                        <option>Pencetakan Sertifikat</option>
                                                        <option>Pemeriksaan Subtantif</option>
                                                        <option>Masa Pengumuman</option>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="card card-info">
                                        ...
                                        <div class="card-footer">
                                            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-addmember" style="float: right;">+</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog modal-xl">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Tambah Anggota Paten</h4>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="card card-success">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="form-group">
                                                                <label style="text-align: justify;">Gelar Akademik</label>
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <label for="academic_degree_front">Depan</label>
                                                                        <select class="form-control" id="academic_degree_front">
                                                                            <option></option>
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <label for="academic_degree_back">Belakang</label>
                                                                        <select class="form-control" id="academic_degree_back">
                                                                            <option></option>
                                                                            <option>S.T.</option>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="member_status">Status Anggota</label>
                                                                <select class="form-control">
                                                                    <option>Ketua</option>
